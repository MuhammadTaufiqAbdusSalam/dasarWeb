<!DOCTYPE html>
<!--kode program ini di gunakan untuk mengirim data form ke server tanpa 
perlu memuat ulang halaman, dan menampilkan respons dari server tanpa perlu navigasi halaman.-->
<html>
<head>
