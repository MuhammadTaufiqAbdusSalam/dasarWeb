<!DOCTYPE html>
<!-- kode program ini digunakan untuk mengumpulkan data dari pengguna 
melalui formulir HTML dan mengirimkannya ke server untuk diproses lebih lanjut menggunakan PHP.-->
<html>
<head>
